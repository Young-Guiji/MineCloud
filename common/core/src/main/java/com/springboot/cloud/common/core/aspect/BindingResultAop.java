...
import com.springboot.cloud.common.core.annotation.ValidateAnnotation;
...
public class BindingResultAop {
	 ...
	 * Validate annotation.
	 */
	@Pointcut("@annotation(com.springboot.cloud.common.core.annotation.ValidateAnnotation)")
